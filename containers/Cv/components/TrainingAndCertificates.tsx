...
export default function TraniningAndCertificates() {
    ...
    return (
        <div>
            <div className="flex items-center justify-between">
                <h2 className="text-lg font-bold"> Təlim və Sertifikat</h2>
                <Button
                            ...
                            <div>
                                <div className="grid grid-cols-4 gap-4">
                                    <h3 className="text-sm font-medium pb-2">
                                        Təlim müəssisəsi  <span className="text-red-500">*</span>
                                    </h3>

                                    <h3 className="text-sm font-medium pb-2">
                                        Təlim və Sertifikat adı
                                    </h3> <div className="flex items-center justify-between pb-2"><h3 className="text-sm font-medium pb-2">
                                        Təlimçi    <span className="text-red-500">*</span>
                                    </h3>
