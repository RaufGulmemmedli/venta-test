...
export default function NotesPage({ vacancyData }: NotesPageProps) {
  ...
  const staticNotes = [
    {
      ...
      text: "Vakansiya üçün müsahibə tarixi təyin edildi"
    },
    {
      id: 2,
      author: "ƏSLİ ÇOLAQOVA HACI QIZI",
      date: "16.10.2024 11:20",
      text: "Vakansiya elanı yeniləndi və yeni şərtlər əlavə edildi"
    },
    {
      id: 3,
      author: "NƏRMİN İSMAYILOVA PAŞA QIZI",
      date: "14.10.2024 10:38",
      text: "Maaş aralığı dəyişdirildi"
    }
  ]
      ...
      {showNoteForm && (
        <Card className="p-4 border-2 border-blue-500 shadow-lg">
          <div className="flex items-center justify-between mb-3">
            <h3 className="text-lg font-semibold">Qeydinizi yazın</h3>
            <Button
              variant="ghost"
              size="sm"
